...
\textsubscript{Source:
\href{https://glgunaratne.github.io/manuscript-tutorial/index.ipynb.html}{Article
Notebook}}
...
distribution\[p(x) = \frac{e^{-\lambda} \lambda^{x}}{x !}\]
\{\#eq-poisson\}where \(\lambda\) is the rate of eruptions per year.
Using \textbf{?@eq-poisson}, the probability of an eruption in the next
